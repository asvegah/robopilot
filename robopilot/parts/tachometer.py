...
from robopilot.parts.pins import InputPin, PinEdge


logger = logging.getLogger("robopilot.parts.tachometer")
...
class SerialEncoder(AbstractEncoder):
    ...
    robopilot/arduino/encoder/encoder.ino  The sketch
...
if __name__ == "__main__":
    ...
    import sys
    import time
    from robopilot.parts.pins import input_pin_by_id
