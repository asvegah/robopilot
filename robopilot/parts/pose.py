...
from robopilot.utils import is_number_type
...
from robopilot.parts.tachometer import Tachometer, MockEncoder
...
class BicyclePose:
    ...
    def __init__(self, cfg, poll_delay_secs:float=0):
        from robopilot.parts.serial_port import SerialPort
        from robopilot.parts.tachometer import (Tachometer, SerialEncoder,
...
class UnicyclePose:
    ...
    def __init__(self, cfg, poll_delay_secs:float=0):
        from robopilot.parts.serial_port import SerialPort
        from robopilot.parts.tachometer import (SerialEncoder,
                                                GpioEncoder, EncoderChannel)
        from robopilot.parts.odometer import Odometer
