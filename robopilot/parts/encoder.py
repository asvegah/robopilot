"""
Deprecated in favor on robopilot.parts.Tachometer and robopilot.parts.Odometer.
...
# The microcontroller should be flashed with this sketch (use the Arduino IDE to do that): https://github.com/zlite/robopilot/tree/master/robopilot/parts/encoder/encoder
# Make sure you check the sketch using the "test_encoder.py code in the Robopilot tests folder to make sure you've got your 
...
@deprecated("Deprecated in favor robopilot.parts.tachometer.Tachometer(SerialEncoder)")
class ArduinoEncoder(object):
    def __init__(self, mm_per_tick=0.0000599, debug=False):
        import serial
        import serial.tools.list_ports
        from robopilot.parts.pigpio_enc import OdomDist
...
class AStarSpeed:
    def __init__(self):
        from robopilot.parts.teensy import TeensyRCin
        self.speed = 0
        self.linaccel = None
...
@deprecated("Deprecated in favor of robopilot.parts.tachometer.Tachometer(GpioEncoder)")
class RotaryEncoder():
