...
class GpsNmeaPositions:
    """
    Robopilot part to convert array of NMEA sentences into array of (x,y) positions
    """
...
class GpsPosition:
    """
    Robopilot part to read NMEA lines from serial port and convert a position
    """
