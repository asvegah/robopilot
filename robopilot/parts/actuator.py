...
from robopilot.utils import clamp
...
from robopilot.parts.pins import OutputPin, PwmPin, PinState
...
def pulse_ms(pulse_bits:int) -> float:
    ...
    Robopilot throttle and steering PWM values are
...
#
# See https://docs.robopilot.com/parts/actuators/#arduino for how to set this up.
