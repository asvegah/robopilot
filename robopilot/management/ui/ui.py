...
from robopilot.management.ui.car_screen import CarScreen
from robopilot.management.ui.pilot_screen import PilotScreen
from robopilot.management.ui.rc_file_handler import rc_handler
from robopilot.management.ui.train_screen import TrainScreen
from robopilot.management.ui.tub_screen import TubScreen
from robopilot.management.ui.common import AppScreen
...
class StartScreen(AppScreen):
    img_path = os.path.realpath(os.path.join(
        ...
        'static/robopilot-logo-sideways.png'))
    pass
...
class DonkeyApp(App):
    ...
    def initialise(self, event):
        ...
        self.root.ids.status.text = 'Robopilot ready'
    ...
    def on_stop(self, *args):
        ...
        if tub:
            tub.close()
        Logger.info("App: Good bye Robopilot")
