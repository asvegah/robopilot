#!/usr/bin/env python3
"""
Scripts to drive a robopilot 4 car
...
from robopilot.parts.controller import LocalWebController, JoystickController, WebFpv
...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[]):
    ...
    if use_joystick or cfg.USE_JOYSTICK_AS_DEFAULT:
        ...
        if cfg.CONTROLLER_TYPE == "MM1":
            ...
            #
            # custom controller created with `robopilot createjs` command
            #
    ...
    if cfg.STOP_SIGN_DETECTOR:
        from robopilot.parts.object_detector.stop_sign_detector import StopSignDetector
