...
python3 -m virtualenv -p python3 ~/.virtualenv/robopilot --system-site-packages
echo "source ~/.virtualenv/robopilot/bin/activate" >> ~/.bashrc
# "source ~/.virtualenv/robopilot/bin/activate" in the shell script
