...
web_controller_html = package_files('robopilot/parts/controllers/templates',
                                    'robopilot/')
...
setup(name='robopilot',
      ...
      keywords='selfdriving cars robopilot diyrobocars',
