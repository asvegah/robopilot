...
from robopilot.parts.cv import CvImageView
from robopilot.parts.graph import Graph
from robopilot.parts.network import ZMQValueSub
...
def condition_values(obj):
    ...
    python ~/projects/donkey_tkramer/robopilot/parts/network.py
    '''
