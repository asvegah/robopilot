...
and have them log into and drive on the SDSandbox robopilot sim server.
Check: https://docs.robopilot.com/guide/simulator/
'''
import os
import time
import random
...
body_styles = ["robopilot", "bare", "car01"]
host = '127.0.0.1'
procs = []
...
for i in range(num_clients):
	...
	with open(conf_file, "wt") as outfile:
		...
		outfile.write('DONKEY_GYM_ENV_NAME = "robopilot-generated-track-v0"\n')
